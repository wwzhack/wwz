...
--restore_path \
    trained_fusionnet/fus18project6ms1bn_16x448x448_lr0-1e3_100_aug0-100_100_bri080-120_con080-120_sat080-120_hflip_l1_sm000_wd000_outrm7-150_dilate0_min1max100_lidar_loss200_interp_with_reproj/model-115000.pth \
--train_image_path \
...
--n_step_per_summary 3000 \
--start_step_validation 3000 \
--n_thread 48 \